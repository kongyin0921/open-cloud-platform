...
import com.ocp.common.search.entity.AggItemVo;
                ...
                AggregationBuilders
                        ...
                        .subAggregation(
                                ...
                                AggregationBuilders
                                        ...
                                        .format(DateConstants.DATETIME_FORMAT)
                                        //时区相差8小时
                                        .timeZone(ZoneId.of(DateConstants.TIME_ZONE_GMT8))
                                        .minDocCount(0L)
                                        .extendedBounds(new LongBounds(
                                                curDateTime.minusDays(1).format(DateTimeFormatter.ofPattern(DateConstants.DATETIME_FORMAT)),
                                                curDateTime.format(DateTimeFormatter.ofPattern(DateConstants.DATETIME_FORMAT))
                                        ))
                                        .subAggregation(
                                                AggregationBuilders
                                                        .cardinality("uv")
                ...
                AggregationBuilders
                        ...
                        .subAggregation(
                                ...
                                AggregationBuilders
                                        ...
                                        .minDocCount(0L)
                                        .extendedBounds(new LongBounds(
                                                localDate.minusDays(6).format(DateTimeFormatter.ofPattern(DateConstants.DATE_FORMAT)),
                                                localDate.format(DateTimeFormatter.ofPattern(DateConstants.DATE_FORMAT))
                                        ))
                                        .subAggregation(
                                                AggregationBuilders
                                                        .cardinality("uv")
