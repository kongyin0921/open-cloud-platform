...
public class SysUserExcel implements Serializable {
    ...
    @Excel(name = "创建时间", format = DateConstants.DATETIME_FORMAT, isImportField = "true_st", width = 20)
    private Date createTime;

    @Excel(name = "修改时间", format = DateConstants.DATETIME_FORMAT, isImportField = "true_st", width = 20)
